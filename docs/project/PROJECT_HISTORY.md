...
50. MVP2 멀티 거래소/멀티 전략 실험 계획 문서화
51. 같은 market 추가 진입 기본 허용과 자금 활용률 개선 계획
52. 포트폴리오 자금 사용률과 남은 매수 가능 횟수 표시
53. 포트폴리오 market별 비중 TOP 표시와 2026-05-06 마이너스 손익 분석 문서화
54. MVP2 패키지와 용어 경계 생성
...
61. Binance PAPER 전용 React 대시보드 추가
