...
- `btc-market-regime-momentum.csv/md`: BTC/ETH 시드 기준 432개 조합 모두 탈락.
  상세 결과는 `docs/trading/condition-records/2026-06-12-btc-market-regime-momentum.md`를 본다.
- `ranked-rotation.csv/md`: 확장 유니버스 Upbit 30 + Binance 30 기준 288개 조합 중 Binance 15m 6개 약한 PAPER 관찰 후보.
  상세 결과는 `docs/trading/condition-records/2026-06-15-ranked-rotation.md`를 본다.
- `ranked-rotation-robustness.csv/md`: Ranked Rotation 생존 후보 6개를 비용/유니버스 시나리오 72개로 재검증.
  상세 결과는 `docs/trading/condition-records/2026-06-15-ranked-rotation-robustness.md`를 본다.
- `session-volatility-breakout.csv/md`: 확장 유니버스 Upbit 30 + Binance 30 기준 640개 조합 중 후보 13개.
  상세 결과는 `docs/trading/condition-records/2026-06-15-session-volatility-breakout.md`를 본다.
- `session-volatility-breakout-robustness.csv/md`: Session Volatility Breakout 생존 후보 13개를 비용/유니버스 시나리오 156개로 재검증.
  상세 결과는 `docs/trading/condition-records/2026-06-15-session-volatility-breakout-robustness.md`를 본다.
- `session-volatility-breakout-maker.csv/md`: Session Volatility Breakout 1순위 후보를 15m coarse maker 지정가 모델 12개 시나리오로 재검증.
  상세 결과는 `docs/trading/condition-records/2026-06-15-session-volatility-breakout-maker.md`를 본다.
- `session-volatility-breakout-submaker.csv/md`: Session Volatility Breakout 1순위 후보를 15m 신호 + 5m/1m 300초 maker 유효성 모델 24개 시나리오로 재검증.
  상세 결과는 `docs/trading/condition-records/2026-06-15-session-volatility-breakout-submaker.md`를 본다.
