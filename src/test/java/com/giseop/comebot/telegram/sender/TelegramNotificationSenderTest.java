...
class TelegramNotificationSenderTest {
    ...
    void sendDoesNotCallApiWhenTelegramIsDisabled() {
        ...
        new TelegramNotificationSender(properties, builder.build()).send(message());
    ...
    void sendDoesNotExposeBotTokenThroughResponseObject() {
        ...
        assertThatCode(() -> new TelegramNotificationSender(properties, builder.build()).send(message()))
