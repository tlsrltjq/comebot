...
echo "Prevent re-entry with position: ${STRATEGY_ENTRY_PREVENT_REENTRY_WITH_POSITION:-false}"
echo "Exit interval: ${TRADING_EXIT_SCHEDULER_FIXED_DELAY_MS:-1000}ms"
