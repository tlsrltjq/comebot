...
MVP2_PAPER_BINANCE_SCHEDULER_ENABLED=true
MVP2_PAPER_BINANCE_SCHEDULER_FIXED_DELAY_MS=30000
```

Binance PAPER scheduler는 실제 주문 없이 Binance public 시세와 in-memory PAPER 포트폴리오만 사용한다. 운영 중 끄려면 `MVP2_PAPER_BINANCE_SCHEDULER_ENABLED=false`로 실행한다.
